...
class OrderModel {
  ...
  OrderModel(
    ...
    this._deliverymanReviewCount = deliveryManReviewCount;
  ...
  OrderModel.fromJson(Map<String, dynamic> json) {
    ...
    _deliveryAddress = json['delivery_address'] != null
        ? new DeliveryAddress.fromJson(jsonDecode(json['delivery_address']))
        : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    data['deliveryman_review_count'] = this._deliverymanReviewCount;

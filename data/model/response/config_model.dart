class ConfigModel {
  ...
  String get resellerPDF => _resellerPDF;
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    if(json['reseller_pdf']!=null){
      _resellerPDF = json['reseller_pdf'];
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['reseller_pdf'] = this._resellerPDF;
    return data;
  }
}
...
class BaseUrls {
  ...
  BaseUrls(
    ...
    this._resellerPdfUrl = resellerPdfUrl;
  ...
  String get resellerPdfUrl => _resellerPdfUrl;
  ...
  BaseUrls.fromJson(Map<String, dynamic> json) {
    ...
    _resellerPdfUrl = json['reseller_pdf_url'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['reseller_pdf_url'] = this._resellerPdfUrl;

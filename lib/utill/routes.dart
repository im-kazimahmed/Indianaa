...
class Routes {
  ...
  static const String SIGNRUP_SCREEN = '/signr-up';
  ...
  static const String CREATEACCOUNTR_SCREEN = '/create-accountr';
  ...
  static const String PAYMENT_WEBVIEW = '/payment-webView';
  static const String PAYMENT_SCREEN = '/payment';
  static const String ORDER_SUCCESS_SCREEN = '/order-successful';
  static const String ORDER_SUCCESSPG_SCREEN = '/order-successfulpg';
  ...
  static String getSignrUpRoute() => SIGNRUP_SCREEN;
  ...
  static String getCreateAccountrRoute(String email) => '$CREATEACCOUNTR_SCREEN?email=$email';
  ...
  static String paymentWebView(String envValue, String page, String type) => '$PAYMENT_WEBVIEW?envValue=$envValue&page=$page&type=$type';

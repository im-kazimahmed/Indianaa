class Strings {
  ...
  static const String request = "merchant_id=2571703&order_id=9445851&redirect_url=https://admin.india-naa.in/admin/auth/login&cancel_url=https://admin.india-naa.in/admin/auth/login&amount=10&currency=INR";
}
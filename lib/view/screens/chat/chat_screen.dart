            ...
            child: Container(width: 40,height: 40,
              ...
              child: ClipRRect(
                ...
                child: CachedNetworkImage(
                  fit: BoxFit.cover,
                  placeholder: (context, url) => _isAdmin ? Image.asset(Images.logo) : Image.asset(Images.profile),
                  imageUrl: _isAdmin ? '' : '${Provider.of<SplashProvider>(context, listen: false).baseUrls.deliveryManImageUrl}/${widget.orderModel.deliveryMan.image}',
                  errorWidget: (c, o, s) =>  Image.asset(_isAdmin ? Images.logo : Images.profile),
                ),
                // child: FadeInImage.assetNetwork(
                //   fit: BoxFit.cover,
                //   placeholder: _isAdmin ? Images.logo : Images.profile,
                ...
                //   imageErrorBuilder: (c,t,o) => Image.asset(_isAdmin ? Images.logo : Images.profile),
                // ),
              ),
            ),
          )

...
import 'widget/buttons_view.dart';
...
class _AddNewAddressScreenState extends State<AddNewAddressScreen> {
        ...
        builder: (context, locationProvider, child) {
          return Column(
            children: [
                              ...
                              child: SizedBox(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    // for label us
                                    if(!ResponsiveHelper.isDesktop(context)) DetailsView(locationProvider: locationProvider, contactPersonNameController: _contactPersonNameController, stateController: _stateController, cityController: _cityController, pinCodeController: _pinCodeController, contactPersonNumberController: _contactPersonNumberController, addressNode: _addressNode, stateNode: _stateNode, cityNode: _cityNode, pinCodeNode: _pinCodeNode, nameNode: _nameNode, numberNode: _numberNode, fromCheckout: widget.fromCheckout, address: widget.address, isEnableUpdate: widget.isEnableUpdate),
                                    if(ResponsiveHelper.isDesktop(context))Row(
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          flex: 4,
                                          child: DetailsView(locationProvider: locationProvider, contactPersonNameController: _contactPersonNameController, stateController: _stateController, cityController: _cityController, pinCodeController: _pinCodeController, contactPersonNumberController: _contactPersonNumberController, addressNode: _addressNode, cityNode: _cityNode, stateNode: _stateNode, pinCodeNode: _pinCodeNode, nameNode: _nameNode, numberNode: _numberNode, isEnableUpdate: widget.isEnableUpdate, address: widget.address, fromCheckout: widget.fromCheckout),
                                        ),
                                      ],
                                    ),
                                  ],
              ...
              if(!ResponsiveHelper.isDesktop(context)) ButtonsView(locationProvider: locationProvider, isEnableUpdate: widget.isEnableUpdate, fromCheckout: widget.fromCheckout, contactPersonNumberController: _contactPersonNumberController, contactPersonNameController: _contactPersonNameController, address: widget.address, pinCodeController: _pinCodeController, cityController: _cityController, stateController: _stateController),
              ...
              child: Stack(
                ...
                GoogleMap(
                  ...
                  initialCameraPosition: CameraPosition(
                    target: widget.isEnableUpdate ? widget.address != null ? LatLng(double.parse(widget.address.latitude), double.parse(widget.address.longitude)) :  LatLng(locationProvider.position.latitude , locationProvider.position.longitude) : _initialPosition,
                    zoom: 16,
                  ),
  ...
  /*void _checkPermission(Function callback, BuildContext context) async {
    ...
    if(permission == LocationPermission.denied) {
      Provider.of<LocationProvider>(context,listen: false).locationController.clear();

...
class DetailsView extends StatelessWidget {
  ...
  const DetailsView({
    ...
    @required this.stateNode, @required this.cityNode,
    @required this.addressNode, @required this.nameNode,
    @required this.numberNode, @required this.pinCodeNode,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // for Pin Code
          Text(
            getTranslated('pin_code', context),
            style: Theme.of(context).textTheme.headline2.copyWith(color: ColorResources.getHintColor(context)),
          ),
          SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
          CustomTextField(
          ...
          if(ResponsiveHelper.isDesktop(context)) Padding(
            ...
            child: ButtonsView(locationProvider: locationProvider, isEnableUpdate: isEnableUpdate, fromCheckout: fromCheckout, contactPersonNumberController: contactPersonNumberController, contactPersonNameController: contactPersonNameController, address: address, stateController: stateController, cityController: cityController, pinCodeController: pinCodeController),
          )
        ],
      ),
    );

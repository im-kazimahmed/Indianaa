...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _scaffoldKey,
      appBar: ResponsiveHelper.isDesktop(context) ? PreferredSize(child: WebAppBar(), preferredSize: Size.fromHeight(100)) : CustomAppBar(title: getTranslated('my_profile', context)),
                                ...
                                child: Stack(
                                  ...
                                  ClipRRect(
                                    ...
                                    child: file != null ? ResponsiveHelper.isMobilePhone() ? Image.file(File(file.path), width: 80, height: 80, fit: BoxFit.fill)
                                        : Image.file(File(file.path), width: 80, height: 80, fit: BoxFit.fill)
                                        : CachedNetworkImage(
                                      ...
                                      errorWidget: (c, o, s) => Image.asset(Images.placeholder(context), height: 80, width: 80, fit: BoxFit.cover),
                                    ),

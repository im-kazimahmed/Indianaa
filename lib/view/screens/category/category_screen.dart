...
import 'package:emarket_user/view/screens/product/widget/price_filter_widget.dart';
                        ...
                        child: FlexibleSpaceBar(
                          ...
                          background: Container(width : ResponsiveHelper.isDesktop(context) ? Dimensions.WEB_SCREEN_WIDTH : MediaQuery.of(context).size.width,
                            ...
                            child: CachedNetworkImage(
                              ...
                              imageUrl: '${Provider.of<SplashProvider>(context, listen: false).baseUrls.categoryBanner}/${_categoryModel.banner!=null?_categoryModel.banner:''??''}',
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text("Sort by price"),
                                DropdownButton(
                                  value: category.filterDropDownValue,
                                  ...
                                  onChanged: (String newValue) {
                                    category.applyFilter(newValue);
                                  },
                                ),
                              ],
                            ),
                          ),
                          Container(width: Dimensions.WEB_SCREEN_WIDTH,
                            child: category.categoryProductList != null ? category.categoryProductList.length > 0 ? GridView.builder(
                              ...
                              itemCount: category.filterDropDownValue != "Select filter" ? category.filteredProductsList.length: category.categoryProductList.length,
                              shrinkWrap: true,
                              physics: NeverScrollableScrollPhysics(),
                              padding: EdgeInsets.all(Dimensions.PADDING_SIZE_SMALL),
                              itemBuilder: (context, index) {
                                return ProductWidget(product: category.filterDropDownValue != "Select filter" ? category.filteredProductsList[index]: category.categoryProductList[index]);
                              },

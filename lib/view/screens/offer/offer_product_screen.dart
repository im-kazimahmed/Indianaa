...
class OfferProductScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: ResponsiveHelper.isDesktop(context)? PreferredSize(child: MainAppBar(), preferredSize: Size.fromHeight(80)) : CustomAppBar(title: getTranslated('offer_product', context)),
                            ...
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              ClipRRect(
                                ...
                                child: CachedNetworkImage(
                                  ...
                                  imageUrl: '${Provider.of<SplashProvider>(context, listen: false).baseUrls.productImageUrl}/${offerProduct.offerProductList[index].image[0]}',
                                  height: 110, width: MediaQuery.of(context).size.width, fit: BoxFit.cover,
                                  errorWidget: (c, o, s) => Image.asset(Images.placeholder(context),height: 110, width: MediaQuery.of(context).size.width, fit: BoxFit.cover),
                                ),

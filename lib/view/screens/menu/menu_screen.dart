...
class _MenuScreenState extends State<MenuScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body:ResponsiveHelper.isDesktop(context) ? MenuScreenWeb(isLoggedIn: _isLoggedIn) : Column(children: [
            ...
            child: Container(
              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                Container(
                  ...
                  child: ClipOval(
                    child: _isLoggedIn ? CachedNetworkImage(
                      placeholder: (context, url) => Image.asset(Images.placeholder(context)),
                      imageUrl: '${Provider.of<SplashProvider>(context,).baseUrls.customerImageUrl}/'

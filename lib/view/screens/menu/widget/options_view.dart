...
import 'package:emarket_user/view/screens/auth/catalogue_screen.dart';
          ...
          child: SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                if(_authProvider.isLoggedIn() && _userType == "Reseller")
                  ListTile(
                    onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context)=> CatalogueScreen())),
                    leading: Image.asset(Images.send, width: 20, height: 20, color: Theme.of(context).textTheme.bodyText1.color),
                    title: Text(getTranslated('catalogue', context), style: rubikMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                  ),
                ListTile(

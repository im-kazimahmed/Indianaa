...
class OrderSuccessfulpgScreen extends StatelessWidget {
  final String orderID;
  final int status;
  OrderSuccessfulpgScreen({@required this.orderID, @required this.status});
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Padding(
                padding: ResponsiveHelper.isDesktop(context) ? EdgeInsets.all(Dimensions.PADDING_SIZE_LARGE) : const EdgeInsets.all(8.0),
                child: Center(
                  child: Container(
                    ...
                    child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                      ...
                      Text(
                        getTranslated(status == 1 ? 'order_placed_successfully' : status == 0 ? 'payment_failed' : 'payment_cancelled', context),
                      ...
                      SizedBox(
                        ...
                        child: Padding(
                          ...
                          child: CustomButton(btnTxt: getTranslated(status == 1 ? 'track_order' : 'back_home', context), onTap: () {
                            if(status == 1) {

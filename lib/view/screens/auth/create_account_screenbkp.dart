...
class CreateAccountrScreen extends StatefulWidget {
  final String email;

  CreateAccountrScreen({@required this.email});

  @override
  _CreateAccountrScreenState createState() => _CreateAccountrScreenState();
}

class _CreateAccountrScreenState extends State<CreateAccountrScreen> {

  _CreateAccountrScreenState(){
    _selectedVal = _rtypeOptions[0];
  }
  ...
  final TextEditingController _rTypeController = TextEditingController();
                          ...
                          children: [
                            ...
                            !authProvider.isLoading
                              ...
                              onTap: () {
                                ...
                                String _rType = _rTypeController.text.trim();

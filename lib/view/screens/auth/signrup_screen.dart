...
class SignrUpScreen extends StatefulWidget {
  @override
  _SignrUpScreenState createState() => _SignrUpScreenState();
}

class _SignrUpScreenState extends State<SignrUpScreen> {
                        ...
                        child: Consumer<AuthProvider>(
                          builder: (context, authProvider, child) => Column(
                            ...
                            children: [
                                        ...
                                        authProvider.checkEmail(_email).then((value) async {
                                          if (value.isSuccess) {
                                            ...
                                            if (value.message == 'active') {
                                              ...
                                              Navigator.pushNamed(context, Routes.getCreateAccountrRoute(_email,));
                                            }
                                          }
                                        });
                                      ...
                                      authProvider.checkPhone(_number).then((value) async {
                                        if (value.isSuccess) {
                                          ...
                                          if (value.message == 'active') {
                                            ...
                                            Navigator.pushNamed(context, Routes.getCreateAccountrRoute(_number));
                                          }
                                        }
                                      });
                              ...
                              InkWell(
                                onTap: () {
                                  Navigator.push(context, MaterialPageRoute(builder: (context)=> CatalogueScreen()));
                                },
                                child: Center(
                                  child: Text(
                                    getTranslated('catalogue', context),
                                    style: Theme.of(context)
                                        .textTheme
                                        .headline3
                                        .copyWith(fontSize: Dimensions.FONT_SIZE_DEFAULT, color: ColorResources.getGreyBunkerColor(context)),
                                  ),
                                ),
                              )*/
                            ],

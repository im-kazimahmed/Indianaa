                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                InkWell(
                                  onTap: () {
                                    Navigator.pushNamed(context, Routes.getSignrUpRoute());
                                  },
                                  child: Padding(
                                    padding: EdgeInsets.all(Dimensions.PADDING_SIZE_SMALL),
                                    child: Row(
                                      ...
                                      children: [
                                        /*Text(
                                          getTranslated('create_an_account_for_reseller', context),
                                          style:
                                          Theme.of(context).textTheme.headline2.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL, color: ColorResources.getGreyColor(context)),
                                        ),*/
                                        SizedBox(width: Dimensions.PADDING_SIZE_SMALL),
                                        Text(
                                          getTranslated('reseller_signup', context),
                                          style: Theme.of(context)
                                              .textTheme
                                              .headline3
                                              .copyWith(fontSize: Dimensions.FONT_SIZE_LARGE, color: ColorResources.getGreyBunkerColor(context)),
                                        ),
                                      ],
                                    ),
                                  ),

...
import 'package:emarket_user/view/screens/notification/widget/notification_dialog.dart';
                                              ...
                                              children: [
                                                Container(
                                                  ...
                                                  child: CachedNetworkImage(
                                                    ...
                                                    imageUrl: '${Provider.of<SplashProvider>(context, listen: false).baseUrls.notificationImageUrl}/${notificationProvider.notificationList[index].image}',
                                                    height: 60,width: 60,fit: BoxFit.cover,
                                                    errorWidget: (c, o, s) => Image.asset(Images.placeholder(context),height: 60,width: 60,fit: BoxFit.cover),
                                                  ),
                                                  ...
                                                  //   height: 60,width: 60,fit: BoxFit.cover,
                                                  //   imageErrorBuilder: (c,b,v)=> Image.asset(Images.placeholder(context),height: 60,width: 60,fit: BoxFit.cover),
                                                  // ),
                                                ),
                                                SizedBox(width: 24.0),
                                                Expanded(

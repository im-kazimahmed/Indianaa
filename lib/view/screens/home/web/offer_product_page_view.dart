                                  ...
                                  Expanded(
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: CachedNetworkImage(
                                        ...
                                        imageUrl: '${Provider.of<SplashProvider>(context, listen: false).baseUrls.productImageUrl}/${offerProduct.offerProductList[_currentIndex].image[0]}',
                                        errorWidget: (c, o, s) => Image.asset(Images.placeholder(context), height: 225.0, width: 368, fit: BoxFit.cover),
                                      ),

                              ...
                              Container( width: 65, height: 65,
                                ...
                                child: ClipRRect(
                                  ...
                                  child: CachedNetworkImage(
                                    ...
                                    imageUrl: '${Provider.of<SplashProvider>(context, listen: false).baseUrls.categoryImageUrl}/${category.categoryList[index].image}',
                                    errorWidget: (c, o, s) => Image.asset(Images.placeholder(context),width: 65, height: 65, fit: BoxFit.cover,),
                                  ),

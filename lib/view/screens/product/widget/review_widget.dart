        ...
        Row(children: [
          ClipRRect(
            ...
            child: CachedNetworkImage(
              ...
              imageUrl: '${Provider.of<SplashProvider>(context, listen: false).baseUrls.customerImageUrl}/${reviewModel.customer != null ? reviewModel.customer.image : getTranslated('user_not_available', context)}',
              width: 50, height: 50, fit: BoxFit.cover,
              errorWidget: (c, o, s) => Image.asset(Images.placeholder(context), width: 50, height: 50,fit: BoxFit.cover),
            ),

                                ...
                                SizedBox(height: 50,
                                    child: Consumer<SplashProvider>(
                                      builder:(context, splash, child) =>
                                        CachedNetworkImage(
                                          placeholder: (context, url) => Image.asset(Images.logo),
                                          imageUrl: splash.baseUrls != null ? '${splash.baseUrls.ecommerceImageUrl}/${splash.configModel.ecommerceLogo}' : '',
                                          fit: BoxFit.contain,
                                          errorWidget: (c, o, s) => Image.asset(Images.logo)),

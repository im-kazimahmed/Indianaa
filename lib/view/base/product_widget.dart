  ...
  Widget build(BuildContext context) {
    ...
    if(product.variations.length != 0) {
     ...
     double _discountedPrice = PriceConverter.convertWithDiscount(
       context,
       product.price,
       isReseller ? product.resellerDiscount: product.discount,
                    ...
                    Expanded(
                      ...
                      child: ClipRRect(
                        ...
                        child: CachedNetworkImage(
                          ...
                          imageUrl: '${Provider.of<SplashProvider>(context, listen: false).baseUrls.productImageUrl}/${product.image[0]}',
                          width: double.infinity,
                    ...
                    Expanded(flex: 4,
                      child: Padding(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.center, children: [
                          ...
                          Text(
                            '${PriceConverter.convertPrice(context, _startingPrice, discount: isReseller ? product.resellerDiscount: product.discount,
                                discountType: product.discountType, asFixed: 1)}''${_endingPrice!= null
                                ? ' - ${PriceConverter.convertPrice(context, _endingPrice, discount: isReseller ? product.resellerDiscount: product.discount,
            ...
            child: Row(children: [
              ClipRRect(
                ...
                child: CachedNetworkImage(
                  ...
                  errorWidget: (c, o, s) => Image.asset(Images.placeholder(context), height: 70, width: 85,  fit: BoxFit.cover),
                ),
                // child: FadeInImage.assetNetwork(
                //   placeholder: Images.placeholder(context),
                //   image: '${Provider.of<SplashProvider>(context, listen: false).baseUrls.productImageUrl}/${product.image[0]}',
              ...
              Expanded(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  SizedBox(height: 10),
                  Text(
                    '${PriceConverter.convertPrice(context, _startingPrice, discount: isReseller ? product.resellerDiscount: product.discount, discountType: product.discountType, asFixed: 1)}'
                        '${_endingPrice!= null ? ' - ${PriceConverter.convertPrice(context, _endingPrice, discount: isReseller ? product.resellerDiscount: product.discount,
                        discountType: product.discountType, asFixed: 1)}' : ''}',

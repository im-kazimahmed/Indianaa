...
import 'package:emarket_user/view/screens/auth/create_accountr_screen.dart';
...
import 'package:emarket_user/view/screens/auth/signrup_screen.dart';
...
import 'package:emarket_user/view/screens/checkout/order_successfulpg_screen.dart';
...
//*******Handlers*********
  ...
  static Handler _signrUpHandler = Handler(handlerFunc: (context, Map<String, dynamic> params) => SignrUpScreen());
  ...
  static Handler _createAccountrHandler = Handler(handlerFunc: (context, Map<String, dynamic> params) {
    return CreateAccountrScreen(email: params['email'][0]);
  });
...
/*  static Handler _checkoutHandler = Handler(handlerFunc: (context, Map<String, dynamic> params) {
  ...
  static Handler _orderSuccesspgHandler = Handler(
      handlerFunc: (context, Map<String, dynamic> params) {
        int _status = (params['status'][0] == 'success' || params['status'][0] == 'payment-success') ? 0 : params['status'][0] == 'fail' ? 1 : 2;
        return OrderSuccessfulpgScreen(orderID: params['id'][0], status: _status);
      }
  );

  static Handler _orderHandler = Handler(handlerFunc: (context, Map<String, dynamic> params) => OrderScreen());
...
//*******Route Define*********
  static void setupRouter() {
    ...
    router.define(Routes.SIGNRUP_SCREEN, handler: _signrUpHandler, transitionType: TransitionType.fadeIn);
    ...
    router.define(Routes.CREATEACCOUNTR_SCREEN, handler: _createAccountrHandler, transitionType: TransitionType.fadeIn);
    ...
    router.define(Routes.ORDER_SUCCESSPG_SCREEN + '/:id/:status', handler: _orderSuccesspgHandler, transitionType: TransitionType.fadeIn);
    router.define(Routes.ORDER_SCREEN, handler: _orderHandler, transitionType: TransitionType.fadeIn);
